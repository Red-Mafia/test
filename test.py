...
while loop == 'true':
    ...
    print '\x1b[1;97m'
    print '\x1b[1;97m '
    username = raw_input('              \x1b[1;92mTOOL USERNAME: ')
...
def reg2():
    ...
    print ''
    print '\x1b[1;96m '
    print ' \xe2\x80\xa2 THIS TOOL IS COMPLETELY CODED BY RED-MAFIA \xe2\x80\xa2 '
    time.sleep(5)
    login()
...
def menu():
    ...
    print ''
    print 47 * '-'
    print ' \x1b[1;97m          Kaash Koi Toh Aesa Ho'
